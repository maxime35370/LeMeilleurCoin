...
class Ville
{
     ...
     * @var float
     *
     * @ORM\Column(name="ville_surface", type="float", nullable=true)
     */
     ...
     * @var float
     *
     * @ORM\Column(name="ville_longitude_deg", type="float", nullable=true)
     */
     ...
     * @var float
     *
     * @ORM\Column(name="ville_latitude_deg", type="float", nullable=true)
     */
